   ...
   // Build the hash table
{
   ...
   // Build the hash table from the [right] side -- Hancel & Giuseppe
...
//---------------------------------------------------------------------------
void HashOptional::ProbePeek::run()
...
//---------------------------------------------------------------------------
HashOptional::HashOptional(Operator* left,Register* leftValue,const vector<Register*>& leftTail,Operator* right,Register* rightValue,const vector<Register*>& rightTail,double hashPriority,double probePriority,double expectedOutputCardinality)
...
{
   out.beginOperator("HashOptional",expectedOutputCardinality,observedOutputCardinality);
...
//---------------------------------------------------------------------------
void HashOptional::addMergeHint(Register* /*reg1*/,Register* /*reg2*/)
